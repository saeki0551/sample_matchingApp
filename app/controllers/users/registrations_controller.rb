...
class Users::RegistrationsController < Devise::RegistrationsController
  ...
  def create 
    if params[:user].present?
      ...
      if User.exists?(email: user.email, is_deleted: false) 
        ...
        return redirect_to  new_user_path, alert: "新規登録できませんでした。ログインするか、#{ACCOUNT_STOP_TIME} 秒後に新規登録してください。" if created_user.is_deleted && Time.zone.now - created_user.cancel_membership_time < ACCOUNT_STOP_TIME
